...
public class WindowsMouseLogger {
    ...
    public static void main(final String[] args) {
        if (!Platform.isWindows()) { throw new UnsupportedOperationException("Not supported on this platform."); }
        ...
        mouseHook = new LowLevelMouseProc() {
            @Override
            public LRESULT callback(final int nCode, final WPARAM wParam, final MOUSEINPUT info) {
                if (nCode >= 0) {
